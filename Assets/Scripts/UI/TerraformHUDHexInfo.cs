...
public partial class TerraformHUD
{
    ...
    private void RefreshHexInfo()
    {
        ...
        string regionInfo = BuildRegionInfo();
    ...
    private string BuildRegionInfo()
    {
        if (_regionContext == null) return string.Empty;
        ...
        else
        {
            ...
            string projectedTerrain = region != null && region.projectedTerrain != null ? region.projectedTerrain.displayName : "?";
            return $"Astre : {bodyName}\n" +
